...
export const DeleteFile: ToolCatalogEntry = {
  ...
  executor: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"fileId":{"type":"string","description":"Canonical workspace file ID of the file to delete."}},"required":["fileId"]},
...
export const Glob: ToolCatalogEntry = {
  ...
  executor: "sim",
  mode: "async",
  parameters: {"type":"object","properties":{"pattern":{"type":"string","description":"Glob pattern to match file paths. Supports * (any segment) and ** (any depth)."},"title":{"type":"string","description":"Short human-readable label shown in the UI while this search runs (e.g. 'Finding workflow configs', 'Listing knowledge bases')."}},"required":["pattern"]},
};
